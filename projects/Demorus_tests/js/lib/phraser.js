function Phraser(text, targetDiv, settings, slider, viewerTa){
	this._text = text;
...
Phraser.fn = Phraser.prototype;

Phraser.fn._initializeFromText = function(text){
...
Phraser.fn.destroy = function(){
	this.pause();
	
	this._destroyed = true;
}

Phraser.fn.changeSettings = function(settings){
...
Phraser.fn.incrementSpeed = function(wpm_plus){
...
Phraser.fn.start = function(){
	this._playing = true;
	
	this.nextFrame();
}

Phraser.fn.nextFrame = function(){
	this.showTextRange();
...
Phraser.fn.moveToPercentage = function(percent){
...
Phraser.fn.showTextRange = function(firstWordIndex){
...
Phraser.fn.setTimeout = function(){
	if(this._destroyed)
...
Phraser.fn.pause = function(){
	clearTimeout(this._curTimeout);
	
	this._playing = false;
}

Phraser.fn.playOrResume = function(){
	this._playing = true;
	
	this.setTimeout();
}

Phraser.fn.rewind = function(){
	this._nextWordIndex = 0;
	
	this.nextFrame();
}

Phraser.fn.selectRangeInViewer = function(start, end){
